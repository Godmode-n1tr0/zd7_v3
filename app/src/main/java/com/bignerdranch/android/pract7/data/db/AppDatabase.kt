...
import com.bignerdranch.android.pract7.data.dao.*
import com.bignerdranch.android.pract7.data.entities.*
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.launch

@Database(entities = [ClientEntity::class, DetailTypeEntity::class, FurnitureDetailCrossRef::class,
    FurnitureItemEntity::class, FurnitureTypeEntity::class, OrderEntity::class, OrderDetailCrossRef::class, SupplierDetailCrossRef::class, SupplierEntity::class],
    version = 5, // Увеличил версию, чтобы исправить ошибку
    exportSchema = false)
    ...
    private class DatabaseCallback(private val context: Context) : RoomDatabase.Callback() {
        override fun onCreate(db: SupportSQLiteDatabase) {
            ...
            CoroutineScope(Dispatchers.IO).launch {
                val furnitureDao = getInstance(context).furnitureDao()
